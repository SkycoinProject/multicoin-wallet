...
import { WalletOptionsComponent } from './components/pages/wallets/wallet-options/wallet-options.component';
import { AddressHistoryComponent } from './components/pages/address-history/address-history.component';
import { GetNextAddressComponent } from './components/layout/get-next-address/get-next-address.component';
