/**
 * Return true if current is equal or superior to target. Versions normally are composed of 3
 * parts, separated by points, but this function only takes into account the first two parts,
 * so 0.24.0 is considered equal to 0.24.1.
 */
