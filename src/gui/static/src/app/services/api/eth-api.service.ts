...
/**
 * Allows to make request to the Ethereum node api with ease. Check the node API documentation for
...
export class EthApiService {
  ...
  /**
   * Calls a RPC method of the Ethereum node. If the call returns an error in the "error" field of
